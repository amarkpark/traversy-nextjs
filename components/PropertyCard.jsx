      ...
      <div className="p-4">
        <div className="text-left md:text-center lg:text-left mb-6">
          <div
            ...
            id={`type-${property._id}`}
            data-testid={`type-${property._id}`}
          >
            {property.type}
          </div>
          <h3
            className="text-xl font-bold"
            id={`name-${property._id}`}
            data-testid={`name-${property._id}`}
          >
            {property.name}
          </h3>
        </div>
        <h3
          className="absolute top-[10px] right-[10px] bg-white px-4 py-2 rounded-lg text-blue-500 font-bold text-right md:text-center lg:text-right"
            ...
            data-testid={`price-${property._id}`}
        >
          {getRateDisplay()}
        </h3>
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          ...
          <Link
            ...
            id={`details-${property._id}`}
            data-testid={`details-${property._id}`}
